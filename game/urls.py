...
from .views_transfer_v2_deals import (
    ...
    transfer_deal_counter_accept,
    transfer_deal_counter_decline,
...
urlpatterns = [
    ...
    path('transfers/deals/gegenforderung-annehmen/', transfer_deal_counter_accept, name='transfer_deal_counter_accept'),
    path('transfers/deals/gegenforderung-ablehnen/', transfer_deal_counter_decline, name='transfer_deal_counter_decline'),
