...
COUNTRY_FLAG_ASSETS = {
    'Afghanistan': {'code': 'AF'},
    'Ägypten': {'code': 'EG', 'asset_id': '14'},
    'Albanien': {'code': 'AL', 'asset_id': '750'},
    'Algerien': {'code': 'DZ', 'asset_id': '5'},
    'Andorra': {'code': 'AD', 'asset_id': '753'},
    'Angola': {'code': 'AO', 'asset_id': '7'},
    'Antigua und Barbuda': {'code': 'AG', 'asset_id': '360'},
    'Äquatorialguinea': {'code': 'GQ', 'asset_id': '58'},
    'Argentinien': {'code': 'AR', 'asset_id': '1642'},
    'Armenien': {'code': 'AM', 'asset_id': '754'},
    'Aserbaidschan': {'code': 'AZ', 'asset_id': '756'},
    'Äthiopien': {'code': 'ET', 'asset_id': '15'},
    'Australien': {'code': 'AU', 'asset_id': '1321'},
    'Bahamas': {'code': 'BS'},
    'Bahrain': {'code': 'BH', 'asset_id': '91'},
    'Bangladesch': {'code': 'BD', 'asset_id': '107'},
    'Barbados': {'code': 'BB', 'asset_id': '362'},
    'Belarus': {'code': 'BY', 'asset_id': '758'},
    'Belgien': {'code': 'BE', 'asset_id': '757'},
    'Belize': {'code': 'BZ', 'asset_id': '363'},
    'Benin': {'code': 'BJ', 'asset_id': '8'},
    'Bhutan': {'code': 'BT'},
    'Bolivien': {'code': 'BO', 'asset_id': '1645'},
    'Bosnien und Herzegowina': {'code': 'BA', 'asset_id': '759'},
    'Bosnien-Herzegowina': {'code': 'BA', 'asset_id': '759'},
    'Botswana': {'code': 'BW', 'asset_id': '9'},
    'Brasilien': {'code': 'BR', 'asset_id': '1651'},
    'Brunei': {'code': 'BN'},
    'Bulgarien': {'code': 'BG', 'asset_id': '760'},
    'Burkina Faso': {'code': 'BF', 'asset_id': '10'},
    'Burundi': {'code': 'BI', 'asset_id': '11'},
    'Chile': {'code': 'CL', 'asset_id': '1646'},
    'China': {'code': 'CN', 'asset_id': '112'},
    'Costa Rica': {'code': 'CR', 'asset_id': '366'},
    'Curacao': {'code': 'CW', 'asset_id': '368'},
    'Dänemark': {'code': 'DK', 'asset_id': '763'},
    'Deutschland': {'code': 'DE', 'asset_id': '771'},
    'Dominica': {'code': 'DM'},
    'Dominikanische Republik': {'code': 'DO', 'asset_id': '370'},
    'Dschibuti': {'code': 'DJ', 'asset_id': '59'},
    'Ecuador': {'code': 'EC', 'asset_id': '1648'},
    'Elfenbeinküste': {'code': 'CI', 'asset_id': '24'},
    'El Salvador': {'code': 'SV', 'asset_id': '371'},
    'England': {'code': 'GB-ENG', 'asset_id': '765'},
    'Eritrea': {'code': 'ER', 'asset_id': '60'},
    'Estland': {'code': 'EE', 'asset_id': '764'},
    'Eswatini': {'code': 'SZ', 'asset_id': '61'},
    'Fidschi': {'code': 'FJ', 'asset_id': '1322'},
    'Finnland': {'code': 'FI', 'asset_id': '766'},
    'Frankreich': {'code': 'FR', 'asset_id': '769'},
    'Guadeloupe': {'code': 'GP'},
    'Gabun': {'code': 'GA', 'asset_id': '16'},
    'Gambia': {'code': 'GM', 'asset_id': '20'},
    'Georgien': {'code': 'GE', 'asset_id': '767'},
    'Ghana': {'code': 'GH', 'asset_id': '17'},
    'Grenada': {'code': 'GD'},
    'Griechenland': {'code': 'GR', 'asset_id': '768'},
    'Guatemala': {'code': 'GT', 'asset_id': '372'},
    'Guinea': {'code': 'GN', 'asset_id': '22'},
    'Guinea-Bissau': {'code': 'GW', 'asset_id': '23'},
    'Guyana': {'code': 'GY'},
    'Haiti': {'code': 'HT', 'asset_id': '373'},
    'Honduras': {'code': 'HN', 'asset_id': '374'},
    'Indien': {'code': 'IN', 'asset_id': '113'},
    'Indonesien': {'code': 'ID', 'asset_id': '114'},
    'Irak': {'code': 'IQ', 'asset_id': '94'},
    'Iran': {'code': 'IR', 'asset_id': '95'},
    'Irland': {'code': 'IE', 'asset_id': '789'},
    'Island': {'code': 'IS', 'asset_id': '782'},
    'Israel': {'code': 'IL', 'asset_id': '783'},
    'Italien': {'code': 'IT', 'asset_id': '776'},
    'Jamaika': {'code': 'JM', 'asset_id': '375'},
    'Japan': {'code': 'JP', 'asset_id': '116'},
    'Jemen': {'code': 'YE', 'asset_id': '109'},
    'Jordanien': {'code': 'JO', 'asset_id': '97'},
    'Kambodscha': {'code': 'KH', 'asset_id': '110'},
    'Kamerun': {'code': 'CM', 'asset_id': '12'},
    'Kanada': {'code': 'CA', 'asset_id': '364'},
    'Kap Verde': {'code': 'CV', 'asset_id': '13'},
    'Kasachstan': {'code': 'KZ', 'asset_id': '98'},
    'Katar': {'code': 'QA', 'asset_id': '103'},
    'Kenia': {'code': 'KE', 'asset_id': '25'},
    'Kirgisistan': {'code': 'KG', 'asset_id': '115'},
    'Kiribati': {'code': 'KI'},
    'Kolumbien': {'code': 'CO', 'asset_id': '1653'},
    'Komoren': {'code': 'KM', 'asset_id': '57'},
    'Kongo (Demokratische Republik)': {'code': 'CD', 'asset_id': '56'},
    'Kongo (Republik)': {'code': 'CG', 'asset_id': '55'},
    'Kongo': {'code': 'CG', 'asset_id': '55'},
    'DR Kongo': {'code': 'CD', 'asset_id': '56'},
    'Korea (Nord)': {'code': 'KP', 'asset_id': '129'},
    'Kosovo': {'code': 'XK', 'asset_id': '3'},
    'Kroatien': {'code': 'HR', 'asset_id': '761'},
    'Kuba': {'code': 'CU', 'asset_id': '369'},
    'Kuwait': {'code': 'KW', 'asset_id': '99'},
    'Laos': {'code': 'LA', 'asset_id': '117'},
    'Lesotho': {'code': 'LS', 'asset_id': '26'},
    'Lettland': {'code': 'LV', 'asset_id': '772'},
    'Libanon': {'code': 'LB', 'asset_id': '100'},
    'Liberia': {'code': 'LR', 'asset_id': '27'},
    'Libyen': {'code': 'LY', 'asset_id': '28'},
    'Liechtenstein': {'code': 'LI', 'asset_id': '774'},
    'Litauen': {'code': 'LT', 'asset_id': '775'},
    'Luxemburg': {'code': 'LU', 'asset_id': '777'},
    'Madagaskar': {'code': 'MG', 'asset_id': '29'},
    'Malawi': {'code': 'MW', 'asset_id': '63'},
    'Malaysia': {'code': 'MY', 'asset_id': '119'},
    'Malediven': {'code': 'MV'},
    'Mali': {'code': 'ML', 'asset_id': '30'},
    'Malta': {'code': 'MT', 'asset_id': '778'},
    'Marokko': {'code': 'MA', 'asset_id': '31'},
    'Marshallinseln': {'code': 'MH'},
    'Mauretanien': {'code': 'MR', 'asset_id': '64'},
    'Mauritius': {'code': 'MU'},
    'Mexiko': {'code': 'MX', 'asset_id': '376'},
    'Mikronesien': {'code': 'FM'},
    'Moldau': {'code': 'MD', 'asset_id': '779'},
    'Monaco': {'code': 'MC', 'asset_id': '780'},
    'Mongolei': {'code': 'MN'},
    'Montenegro': {'code': 'ME', 'asset_id': '803'},
    'Mosambik': {'code': 'MZ', 'asset_id': '65'},
    'Myanmar': {'code': 'MM'},
    'Namibia': {'code': 'NA', 'asset_id': '32'},
    'Nauru': {'code': 'NR'},
    'Nepal': {'code': 'NP'},
    'Neuseeland': {'code': 'NZ', 'asset_id': '1324'},
    'Nicaragua': {'code': 'NI', 'asset_id': '378'},
    'Niederlande': {'code': 'NL', 'asset_id': '784'},
    'Niger': {'code': 'NE', 'asset_id': '33'},
    'Nigeria': {'code': 'NG', 'asset_id': '38'},
    'Nordmazedonien': {'code': 'MK', 'asset_id': '781'},
    'Norwegen': {'code': 'NO', 'asset_id': '786'},
    'Oman': {'code': 'OM', 'asset_id': '101'},
    'Österreich': {'code': 'AT', 'asset_id': '755'},
    'Pakistan': {'code': 'PK', 'asset_id': '120'},
    'Palästina': {'code': 'PS', 'asset_id': '102'},
    'Palau': {'code': 'PW'},
    'Panama': {'code': 'PA', 'asset_id': '379'},
    'Papua-Neuguinea': {'code': 'PG', 'asset_id': '1323'},
    'Paraguay': {'code': 'PY', 'asset_id': '1655'},
    'Peru': {'code': 'PE', 'asset_id': '1656'},
    'Philippinen': {'code': 'PH', 'asset_id': '121'},
    'Polen': {'code': 'PL', 'asset_id': '787'},
    'Portugal': {'code': 'PT', 'asset_id': '788'},
    'Ruanda': {'code': 'RW', 'asset_id': '39'},
    'Rumänien': {'code': 'RO', 'asset_id': '791'},
    'Russland': {'code': 'RU', 'asset_id': '792'},
    'Salomonen': {'code': 'SB', 'asset_id': '1325'},
    'Sambia': {'code': 'ZM', 'asset_id': '51'},
    'Samoa': {'code': 'WS', 'asset_id': '1326'},
    'San Marino': {'code': 'SM', 'asset_id': '795'},
    'São tomé und Príncipe': {'code': 'ST', 'asset_id': '67'},
    'Saudi-Arabien': {'code': 'SA', 'asset_id': '104'},
    'Schottland': {'code': 'GB-SCT', 'asset_id': '790'},
    'Schweden': {'code': 'SE', 'asset_id': '797'},
    'Schweiz': {'code': 'CH', 'asset_id': '798'},
    'Senegal': {'code': 'SN', 'asset_id': '41'},
    'Serbien': {'code': 'RS', 'asset_id': '802'},
    'Seychellen': {'code': 'SC'},
    'Sierra Leone': {'code': 'SL', 'asset_id': '42'},
    'Simbabwe': {'code': 'ZW', 'asset_id': '52'},
    'Singapur': {'code': 'SG', 'asset_id': '124'},
    'Slowakei': {'code': 'SK', 'asset_id': '793'},
    'Slowenien': {'code': 'SI', 'asset_id': '794'},
    'Somalia': {'code': 'SO', 'asset_id': '43'},
    'Spanien': {'code': 'ES', 'asset_id': '773'},
    'Sri Lanka': {'code': 'LK', 'asset_id': '125'},
    'St. Kitts und Nevis': {'code': 'KN'},
    'St. Lucia': {'code': 'LC'},
    'St. Vincent und die Grenadinen': {'code': 'VC'},
    'Südafrika': {'code': 'ZA', 'asset_id': '44'},
    'Sudan': {'code': 'SD', 'asset_id': '45'},
    'Südkorea': {'code': 'KR', 'asset_id': '135'},
    'Südsudan': {'code': 'SS'},
    'Suriname': {'code': 'SR', 'asset_id': '380'},
    'Syrien': {'code': 'SY', 'asset_id': '105'},
    'Tadschikistan': {'code': 'TJ', 'asset_id': '126'},
    'Tansania': {'code': 'TZ', 'asset_id': '47'},
    'Thailand': {'code': 'TH', 'asset_id': '122'},
    'Timor-Leste': {'code': 'TL'},
    'Togo': {'code': 'TG', 'asset_id': '48'},
    'Tonga': {'code': 'TO', 'asset_id': '1327'},
    'Trinidad und Tobago': {'code': 'TT', 'asset_id': '381'},
    'Tschad': {'code': 'TD', 'asset_id': '53'},
    'Tschechien': {'code': 'CZ', 'asset_id': '762'},
    'Tunesien': {'code': 'TN', 'asset_id': '49'},
    'Türkei': {'code': 'TR', 'asset_id': '799'},
    'Turkmenistan': {'code': 'TM', 'asset_id': '127'},
    'Tuvalu': {'code': 'TV'},
    'Uganda': {'code': 'UG', 'asset_id': '50'},
    'Ukraine': {'code': 'UA', 'asset_id': '800'},
    'Ungarn': {'code': 'HU', 'asset_id': '770'},
    'Uruguay': {'code': 'UY', 'asset_id': '1657'},
    'Usbekistan': {'code': 'UZ', 'asset_id': '128'},
    'Vanuatu': {'code': 'VU', 'asset_id': '1328'},
    'Venezuela': {'code': 'VE', 'asset_id': '1658'},
    'Vereinigte Arabische Emirate': {'code': 'AE', 'asset_id': '106'},
    'Vereinigte Staaten': {'code': 'US', 'asset_id': '390'},
    'Vereinigtes Königreich': {'code': 'GB'},
    'Vietnam': {'code': 'VN', 'asset_id': '123'},
    'Wales': {'code': 'GB-WLS', 'asset_id': '801'},
    'Zentralafrikanische Republik': {'code': 'CF', 'asset_id': '54'},
    'Zypern': {'code': 'CY', 'asset_id': '805'},
}
