  ...
  return'<div class="art-blocks">'+blocks.map(function(b){
    ...
    if(b.k==='player'){
      ...
      return'<div class="blk-player">'+
        (f.portrait!==false&&p.img?'<img src="'+p.img+'" onerror="this.onerror=null;this.src=\'/static/game/images/default_player.svg\'" alt="">':'')+
    ...
    if(b.k==='motm'){
      ...
      return'<div class="blk-player" style="flex-direction:column;align-items:flex-start;gap:12px;border-color:rgba(255,213,0,.3);background:linear-gradient(135deg,rgba(255,213,0,.05),rgba(255,195,0,.02))">'+
        ...
        (mo.img?'<img src="'+mo.img+'" onerror="this.onerror=null;this.src=\'/static/game/images/default_player.svg\'" alt="" style="height:72px;width:54px;object-fit:cover;object-position:top center;border-radius:6px;filter:drop-shadow(0 0 10px rgba(255,213,0,.28))">':'')+
